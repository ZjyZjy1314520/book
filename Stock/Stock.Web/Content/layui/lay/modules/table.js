...
function (e) {
    ...
    H.prototype.pullData = function (e, i) {
        ...
        if (n.url) {
            ...
            t.ajax({
                ...
                error: function (e, t) {
                    a.layMain.html('<div class="' + h + '">数据接口请求异常</div>'),
                    a.renderForm(),
                    i && l.close(i)
                }
            })
    ...
    H.prototype.renderData = function (e, n, o, r) {
        ...
        d.cache[c.key] = u,
        r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + h).remove(), c.layMain.append('<div class="' + h + '">无数据</div>')) : (m(), void (s.page && (c.page = n, c.count = o, a.render({
    ...
    H.prototype.sort = function (e, i, a, n) {
        ...
        try {
            ...
            u.layHeader.find("th").find(C).removeAttr("lay-sort"),
        ...
        function () {
            ...
            if (!e.data("off")) {
                if (e.data("edit")) {
                    ...
                    return o[0].value = e.data("content") || i.text(),
